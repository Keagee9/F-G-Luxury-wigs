      ...
      return (
          <div className="container mx-auto px-4 py-16 md:py-24 flex items-center justify-center">
              <Card className="max-w-md w-full text-center p-8">
                  ...
                  <h1 className="text-2xl font-headline font-bold">Consultation Confirmed!</h1>
                  <p className="text-muted-foreground mt-2">
                   ...
                   <Button onClick={resetPurchase} className="mt-6 w-full">Purchase Another Consultation</Button>
              </Card>
          </div>
      )
  }
             ...
             <div className="max-w-2xl mx-auto">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Send Your Deposit via Zelle to confirm your consultation.</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                        <Alert>
                         ...
                         <p className="text-sm text-muted-foreground">A <strong className="text-primary">25% deposit</strong> is required to secure your consultation. This will be applied to your total service cost.</p>
  ...
  return (
    <div className="container mx-auto px-4 py-8 md:py-16">
      <div className="text-center max-w-3xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-headline font-bold">Purchase a Virtual Consultation</h1>
